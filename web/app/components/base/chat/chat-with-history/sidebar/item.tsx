  ...
  return (
    <div
      ...
      className={`
        ...
        ${currentConversationId === item.id && 'text-gray-450 bg-gray-100'}
      `}
      onClick={() => onChangeConversation(item.id)}
    >
      <MessageDotsCircle className={`shrink-0 mt-1 mr-2 w-4 h-4 text-gray-400 ${currentConversationId === item.id && 'text-gray-400'}`} />
